...
# forcing_reshaped_test = forcing_reshaped_test[indiced_test]
...
del sol, diffusion, sol_sliced_train, sol_sliced_test, sol_reshaped_train, sol_reshaped_test, diffusion_sliced_train, (
    diffusion_sliced_test), diffusion_reshaped_train, diffusion_reshaped_test
